    ...
    <MainContainer className="pt-30">
      <article className="text-sm md:text-base text-text-primary leading-relaxed space-y-6">
        ...
        <p>
          ...
          connaissance des utilisateurs du présent site internet les
        ...
        <section className="space-y-2" aria-labelledby="editeur-du-site">
          ...
          <p>
            Société à responsabilité limitée au capital social de 5 000,00
            euros.
          </p>
          <div className="mt-6">
            <h3 className="text-white font-medium text-lg">Siège social</h3>
          ...
          <div className="mt-6">
            <p>
              ...
              sous le numéro 944 948 074.
            </p>
            <p>
              Numéro individuel d’identification à la taxe sur la valeur ajoutée
              : FR83944948074.
            </p>
          ...
          <div className="mt-6">
            ...
            <p>Monsieur Kosivtchouk Youriy, agissant en qualité de Gérant.</p>
            <p>
        ...
        <section className="space-y-2" aria-labelledby="acces-site">
          ...
          <p>
            Le site est accessible en permanence, sous réserve d’interruptions
            temporaires liées à la maintenance, aux mises à jour techniques ou à
        ...
        <section
          className="space-y-2"
          aria-labelledby="propriete-intellectuelle"
        >
          <h2
          ...
          <p>
            L’ensemble des éléments présents sur le site, notamment textes,
            dénominations, logos, visuels, photographies, graphismes, structure,
            présentation et contenus, est protégé par les dispositions légales

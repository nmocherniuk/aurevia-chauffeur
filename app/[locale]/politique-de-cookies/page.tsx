    ...
    <MainContainer className="pt-30">
      <article className="text-sm md:text-base text-text-primary leading-relaxed space-y-6">
        ...
        <section className="space-y-2" aria-labelledby="donnees-collectees">
          ...
          <p>
            Selon la nature des demandes adressées, les données suivantes
            peuvent notamment être collectées :
          </p>
        ...
        <section className="space-y-2" aria-labelledby="finalites-traitement">
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>
              transmettre les informations strictement nécessaires aux
        ...
        <section className="space-y-2" aria-labelledby="destinataires-donnees">
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>
              aux autorités légalement compétentes lorsque la réglementation
              l’exige.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-2" aria-labelledby="duree-conservation">
          ...
          <p>
            Les données sont conservées pendant la durée nécessaire à leur
            finalité puis archivées selon les délais légaux applicables.
          </p>
        </section>
        ...
        <section className="space-y-2" aria-labelledby="droits-personnes">
          ...
          <p>
            Toute demande peut être adressée à : kosivtchoukyouriy@gmail.com
          </p>
          <p>
            En cas de difficulté persistante, une réclamation peut être
            introduite auprès de la Commission Nationale de l’Informatique et
            des Libertés.
          </p>
        </section>

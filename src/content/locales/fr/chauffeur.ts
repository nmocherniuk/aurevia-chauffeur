...
export function createChauffeurContent(locale: "fr" | "en") {
  ...
  return {
    ...
    popularRoutes: {
      ...
      travelTransfers: [
        { id: 1, from: "Aéroport de Nice", to: "Monaco", duration: "40 min", distance: 30 },
        { id: 2, from: "Aéroport de Nice", to: "Cannes", duration: "30 min", distance: 27 },
        { id: 3, from: "Aéroport de Nice", to: "Saint-Tropez", duration: "1 h 30 min", distance: 100 },
        { id: 4, from: "Aéroport de Nice", to: "Antibes / Cap d'Antibes", duration: "25 min", distance: 20 },
        { id: 5, from: "Monaco", to: "Milan / Portofino", duration: "3 h 30 min", distance: 300 },
        { id: 6, from: "Cannes", to: "Aéroport de Marseille", duration: "2 h", distance: 180 },
      ],
      winterTrips: [
